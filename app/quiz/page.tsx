...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    afterCard: {
      ...
      ageInsight: {
        "18–24": "18-24 yaşta ekran ışığı ve geç saatler, gece uyanmalarını %40 artırıyor.",
        "25–34": "Bu yaş grubunda gece uyanmalarının başlıca nedeni: işlenmemiş iş stresi ve aktif zihin.",
        "35–44": "35-44 yaşta hormonal değişimler gece uyanmalarını ortalama %30 artırıyor.",
        "45+": "Bu yaştan itibaren uyku mimarisi değişir — gece uyanmaları normalleşebilir, ama yönetilebilir.",
      },
  ...
  },
  {
    ...
    afterCard: {
      ...
      ageInsight: {
        "18–24": "Kronik düşük uyku kalitesi 30'lu yaşlarda metabolik ve hormonal risk oluşturuyor.",
        "25–34": "Bu grupta her 3 kişiden 1'i iş performans kaybını uyku kalitesiyle ilişkilendiriyor.",
        "35–44": "Bu dönemde uyku kalitesinin düşmesi kortizol seviyelerini %24 artırıyor.",
        "45+": "Bu yaştan itibaren uyku kalitesini iyileştirmek, bilişsel gerilemeyi önemli ölçüde yavaşlatıyor.",
      },
